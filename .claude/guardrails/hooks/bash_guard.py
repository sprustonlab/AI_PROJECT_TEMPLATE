...
# --- R04: subagent-push-block (deny) ---
if re.search(r'''git\s+push\b''', command):
    _pcode, _pmsg = _rg.check_role(
        allow=None, block=['Subagent'],
        enforce='deny', message='[GUARDRAIL DENY R04] Only Coordinator can push to remote. Ask Coordinator to push for you.')
    if _pcode != 0:
        _matched_rules.append((_pcode, 'R04', 'deny', _pmsg or """[GUARDRAIL DENY R04] Only Coordinator can push to remote. Ask Coordinator to push for you."""))
