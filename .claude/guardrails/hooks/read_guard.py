#!/usr/bin/env python3
"""read_guard.py — AUTO-GENERATED by generate_hooks.py — DO NOT EDIT
...
# --- FW15: fw-read-deny (deny) ---
if re.search(r'''\.classified$''', file_path, re.IGNORECASE):
    _matched_rules.append((1, 'FW15', 'deny', """[FW15] Cannot read .classified files."""))
